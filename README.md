...
## Description
This application is a simple budgeting tool that utilises envelope budgeting, allowing users to allocate their income to specific categories, providing users a clear, manageable way to monitor their expenses. This application allows users to track 
